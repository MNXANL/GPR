...
int main(int argc, char **argv)
{
	...
	else
	{
		...
		return -1;*/
		cout << "No arguments => Loading default (moai) model..." << endl;
		cout << "[FYI] Usage:\t";
		cout << argv[0] << " <Triangle mesh>" << endl << endl;
		char moai[28] = "../../corrupted/moai.ply";
		if ( !Application::instance().loadScan( moai ) )
		{
			cout << "No model found! Exiting program :(" << endl;
			return -1;
		}
	}
